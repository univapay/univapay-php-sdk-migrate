...
return [
    'retry_handler' => \Univapay\Requests\Handlers\BasicRetryHandler::class,
    'server_error_class' => 'Univapay\Errors\UnivapayServerError',
    'rate_limit_handler' => \Univapay\Requests\Handlers\RateLimitHandler::class,
